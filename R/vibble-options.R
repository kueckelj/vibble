...
vbl_opts_default <-
  list(
    ...
    vibble.ask = TRUE,
    vibble.clr.bb = "#4DA3D9",
    vibble.clr.bb.data = "#F28E2B",
    vibble.clr.bb.plot = "#4CB36B",
    vibble.clr.bb.screen = "#E15759",
    vibble.clr.bb.slice = "#8F7BD4",
    vibble.clr.grid = "lightgrey",
    vibble.clr.labels = "white",
    vibble.clr.mask = "#9ADBE8",
    vibble.clr.outline = "gold",
    vibble.clr.slice.numbers = "white",
    vibble.clr.slice.projections = "tomato",
    vibble.clrp = "default",
