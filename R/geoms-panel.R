...
#' @export
#' @keywords internal
GeomSegmentPanel <- ggplot2::ggproto(
  `_class` = "GeomSegmentPanel",
...
#' @export
#' @keywords internal
GeomTextPanel <- ggplot2::ggproto(
  `_class` = "GeomTextPanel",
  `_inherit` = ggplot2::Geom,
